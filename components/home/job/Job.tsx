...
const Job = () => {
  return (
    <div className='pt-16 pb-16'>
        <SectionHeading heading='Featured Jobs' subHeading='Know your worth and find the job that qualify your job' />
        <div className='w-[95%] sm:w-[80%] mx-auto mt-16 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10 items-center'>
            {
                jobs.map(job=>{
