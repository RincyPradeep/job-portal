...
const PriceCard = ({type, price}:Props) => {
  return (
    <div className='bg-gray-100 dark:bg-gray-700 p-10 rounded-lg relative'>
        {/* Type check for recomended */}
        {type === "Standared" && 
        <div className='absolute top-7 right-7 px-6 py-1.5 rounded-full bg-green-800 text-white text-xs'>
            Recomended
        </div>
        }
        ...
        <div className='mt-8 text-center'>
            ...
            hover:bg-blue-700 hover:text-white transition-all duration-300 cursor-pointer'>
                View Profile
            </button>
        </div>
    </div>
