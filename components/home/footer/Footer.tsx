  ...
  return (
    <div className='pt-16 pb-16 bg-gray-200 dark:bg-gray-900'>
        <div className='w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-10 items-start'>
            ...
            <div className='xl:col-span-2'>
                ...
                <p className='mt-4 text-gray-600 dark:text-gray-400 text-sm'>
                    ...
                    Nesciunt et sequi velit aliquid debitis consequatur cumque enim dolores quisquam. Culpa!
                </p>
                {/* call */}
                <div className='mt-5'>
                    <h1 className='lg:text-xl text-base text-gray-700 dark:text-gray-300 font-medium'>Call Us</h1>
                    <p className='mt-1 text-gray-600 dark:text-gray-300 lg:text-lg text-base font-bold'>+987654321098</p>
                </div>
                {/* Address */}
                <p className='text-sm text-gray-600 dark:text-gray-400 mt-4'>Dhaka Tangail</p>
                <p className='text-sm text-gray-600 dark:text-gray-400 mt-2'>Dhaka Tangail Bangladesh</p>
                <p className='text-sm text-gray-600 dark:text-gray-400 mt-2'>example@gmail.com</p>
            </div>
            {/* 2nd part */}
            <div className='space-y-6'>
                <h1 className='text-lg font-bold text-gray-800 dark:text-gray-200'>For Cadidates</h1>
                <p className='footer__link'>Browse Jobs</p>
                <p className='footer__link'>Browse Categories</p>
                <p className='footer__link'>Candidates Dashboard</p>
                <p className='footer__link'>Job Alert</p>
        ...
        <div className='pt-6 mt-10 border-t w-[90%] mx-auto border-gray-300 dark:border-gray-800'>
            <p className='text-gray-500'>© 2026 abc. All Right Reserved.</p>
        </div>
    </div>
  )
}
